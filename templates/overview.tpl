...
$(document).ready(function() {
    ...
    function checkLengthStudy( o, n, min, max ) {
     ...
     function createStudy() {
      ...
      valid = valid && checkLengthStudy( study_description, "Study Description", 10, 300 );
    ...
    function checkLengthLineage( o, n, min, max ) {
     ...
     function createLineage() {
      ...
      valid = valid && checkLengthLineage( lineage_description, "Lineage Description", 10, 300 );
	...
	function editLineage()
	{
      ...
      valid = valid && echeckLengthLineage( elineage_description, "Lineage Description", 10, 300 );
	...
	function editStudy()
	{
      ...
      valid = valid && echeckLengthStudy( estudy_description, "Study Description", 10, 300 );
