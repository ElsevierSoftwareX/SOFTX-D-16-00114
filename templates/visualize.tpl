{include file="head.internal.tpl" title="3D-Visualization / {$thisproject.project_name}"}
		...
		function readyRender()
		{
			...
			function init() {
				...
				camera.position.y = 110*zoomFactor;
				camera.position.z = 180*zoomFactor;
				...
				switch(e.which) {
					case 83: // s = take screenshot
						window.open( renderer.domElement.toDataURL( 'image/png' ), 'screenshot_'+Math.random());
					break;
...
<div class="bottom"><div class="explanation">Drag mouse to <b>rotate</b>. Use mouse wheel to <b>zoom</b>. Press 'o' for <b>original camera</b> position.<br>Use 's' key to take a <b>screenshot</b>. Press 'n' for the <b>next</b> Field and 'b' for the <b>previous</b> one.</div></div>
